export const INDIA_STATES_AND_DISTRICTS: Record<string, string[]> = {
    ...
    "Odisha": [
        ...
        "Khordha", "Root", "Malkangiri", "Mayurbhanj", "Nabarangpur", "Nayagarh",
    ...
    "Telangana": [
        ...
        "Nizamabad", "Peddalapalli", "Rajanna Sircilla", "Rangareddy", "Sangareddy",
...
export const TAMIL_NADU_TALUKS: Record<string, string[]> = {
    ...
    "Chengalpattu": ["Chengalpattu", "Madhuranthakam", "Tambaram", "Pallavaram", "Vandalur"],
    "Chennai": ["Mylapore", "Guindy", "Ambattur", "Velachery", "Tondiarpet", "Egmore", "Mambalam", "Aminjikarai"],
    "Coimbatore": ["Coimbatore North", "Coimbatore South", "Pollachi", "Mettupalayam", "Sulur", "Valparai"],
    "Cuddalore": ["Cuddalore", "Chidambaram", "Panruti", "Vriddhachalam", "Tittakudi"],
    "Dharmapuri": ["Dharmapuri", "Harur", "Palacode", "Pennagaram", "Pappireddipatti"],
    "Dindigul": ["Dindigul", "Palani", "Kodaikanal", "Oddanchatram", "Natham"],
    "Erode": ["Erode", "Gobichettipalayam", "Perundurai", "Bhavani", "Sathyamangalam"],
    "Kallakurichi": ["Kallakurichi", "Sankarapuram", "Chinnasalem", "Ulundurpet"],
    "Kanchipuram": ["Kanchipuram", "Sriperumbudur", "Kundrathur", "Walajabad"],
    "Kanyakumari": ["Nagercoil", "Kalkulam", "Thovalai", "Agastheeswaram", "Vilavancode"],
    "Karur": ["Karur", "Aravakurichi", "Kulithalai", "Krishnarayapuram"],
    "Krishnagiri": ["Krishnagiri", "Hosur", "Pochampalli", "Denkanikottai", "Uthangarai"],
    "Madurai": ["Vadipatti", "Madurai South", "Madurai North", "Thiruparankundram", "Melur", "Usilampatti"],
    ...
    "Pudukkottai": ["Pudukkottai", "Alangudi", "Aranthangi", "Illuppur", "Gandarvakottai"],
    "Ramanathapuram": ["Ramanathapuram", "Rameswaram", "Paramakudi", "Tiruvadanai", "Kadaladi"],
    "Ranipet": ["Ranipet", "Walajah", "Arkonam", "Kalavai", "Sholinghur"],
    "Salem": ["Salem", "Attur", "Mettur", "Omalur", "Sankari", "Yercaud"],
    "Sivaganga": ["Sivaganga", "Karaikudi", "Devakottai", "Manamadurai", "Ilayangudi"],
    "Tenkasi": ["Tenkasi", "Sankarankovil", "Sivagiri", "Alangulam", "Kadayanallur"],
    ...
    "Thoothukudi (Tuticorin)": ["Thoothukudi", "Kovilpatti", "Tiruchendur", "Ettayapuram", "Srivaikuntam"],
    "Tiruchirappalli": ["Tiruchirappalli", "Lalgudi", "Musiri", "Thuraiyur", "Manapparai"],
    ...
    "Tiruppur": ["Tiruppur", "Avinashi", "Dharapuram", "Udumalaipettai", "Palladam", "Kangeyam"],
    "Tiruvallur": ["Tiruvallur", "Avadi", "Ponneri", "Gummidipoondi", "Tiruttani"],
    "Tiruvannamalai": ["Tiruvannamalai", "Arani", "Chengam", "Cheyyar", "Polur", "Vandavasi"],
    "Tiruvarur": ["Tiruvarur", "Mannargudi", "Thiruthuraipoondi", "Nannilam", "Kodavasal"],
    "Vellore": ["Vellore", "Katpadi", "Gudiyatham", "Anaicut", "Pernambut"],
    "Viluppuram": ["Viluppuram", "Tindivanam", "Gingee", "Vanur", "Marakkanam"],
